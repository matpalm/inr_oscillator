...
# suppress: UserWarning: The `keras.constraints.serialize()` API should only be used for
#           objects of type `keras.constraints.Constraint`. Found an instance of type
#           <class 'qkeras.quantizers.quantized_bits'> ...
