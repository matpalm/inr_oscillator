...
uv run -m keras_v.train \
 ...
 --num-fourier-features 2048 --rff-basis gaussian --rff-scale-min 0.1 --rff-scale-max 5.0 --rff-l1 1e-7 \
 --mlp-dims 12 16 16 --film-layers 1 \
 ...
 --gamma-slope 0.1 --delta-dc 1e-4 --lambda-morph-consistency 0.2 \
 --epochs 100 --learning-rate 1e-3 --cosine-schedule \
 --num-train-samples 100_000 --batch-size 64
...
uv run -m qkeras_v.train \
 ...
 --num-train-samples 20_000 --batch-size 64
