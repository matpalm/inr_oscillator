...
export RUN=179_film_cache_test

# works with
#   --num-fourier-features 512 --mlp-dims 8 8 8
#   --num-fourier-features 512 --mlp-dims 16 16 16
#   --num-fourier-features 512 --mlp-dims 32 16 16 ?
